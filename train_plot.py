...
def plot_training_results(loss_list, perplexity_list, gpu_mem_list):
    ...
    # Plot Perplexity
    plt.subplot(1, 2, 2)
    plt.plot(epochs, perplexity_list, label='Perplexity', marker='o', color='orange')
    ...
    plt.plot(epochs, gpu_mem_list, label='GPU Memory Usage', marker='o', color='green')
...
if __name__ == "__main__":
    ...
    print("---------------EXECUTING VANILLA LLAMA TRAINING----------------")
    ...
    plot_training_results(loss,ppl,mem)

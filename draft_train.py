...
class SupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str, tokenizer: torch.nn.Module):
        ...
        # Replace utils.jload with your own data loading logic
...
def train():
    ...
    model_class = Llama.build(
            ckpt_dir=ckpt_path,
            tokenizer_path=tokenizer_path,
            max_seq_len=256,
            max_batch_size=1
            )
    model = llama_class.model  # Define your own model class
    ...
    for epoch in range(training_args.num_epochs):
        model.train()
        for batch in DataLoader(data_module['train_dataset'], batch_size=training_args.batch_size, shuffle=True):
